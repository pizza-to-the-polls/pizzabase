...
export const TEMPLATES: readonly string[] = [
  ...
  "👾  👾  👾  👾\n🚀  🚀  🚀  🚀\n🍕  🍕  🍕  🍕\n\nthe pizza armada from {{2. Restaurant}} has landed at {{2. Location Address}} {{2. Location City}} with {{3. Pizzas}}!",
  ...
  "making sure your ballot is counted and your hunger is history. {{3. Pizzas}} from {{2. Restaurant}} → {{2. Location Address}} {{2. Location City}}",
  ...
  "no lines, no problem... wait, actually there IS a line. but we sent {{3. Pizzas}} from {{2. Restaurant}} to {{2. Location Address}} {{2. Location City}} to make it better!",

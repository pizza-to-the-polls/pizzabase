 ...
 * We configure Jest to transform uuid's ESM .js files through ts-jest
 * (see jest.config.js transformIgnorePatterns and the .js transform rule),
 * so we can keep uuid up-to-date without pinning to an insecure version.
 */
